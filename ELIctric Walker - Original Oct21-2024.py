...
while True:
   ...
   score = 0
   co_score = 1
   print("How many classes you want to have?")
   classes = abs(int(input("At least 3 classes: ")))
   if classes < 3:
      classes = 3
   ...
   while t:
       ...
       print("For this minute, you want to")
       o = int(input("1.play 2.listen 3.peek: "))
       if o == 1:
